...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.1.33:27017/wallboarddb',
  ...
  serverURL: 'https://172.31.237.180:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.31.237.180:' + apiport + '/api',
  liveQuery: {
